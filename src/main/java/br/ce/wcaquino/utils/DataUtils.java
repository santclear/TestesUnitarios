...
public class DataUtils {
	...
	/**
	 * Retorna uma instancia de <code>Date</code> refletindo os valores passados por parametro
	 * 
	 * @param dia
	 * @param mes
	 * @param ano
	...
	/**
	 * Verifica se uma data e igual a outra
	 * 	Esta comparacao considera apenas dia, mes e ano
	 * 
	 * @param data1
	 * @param data2
	 * @return
	...
	/**
	 * Verifica se uma determinada data e o dia da semana desejado
	 * 
	 * @param data Data a ser avaliada
	 * @param diaSemana <code>true</code> caso seja o dia da semana desejado, <code>false</code> em caso contrario 
	 * @return
	 */
